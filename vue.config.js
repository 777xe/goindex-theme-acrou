...
// Set libraries not involved in the build
let externals = {};
...
module.exports = {
  ...
  chainWebpack: (config) => {
     ...
     * And the prefetch tag generated during pre-rendering is a modern version, which is not needed for lower version browsers
     */
    if (isProd) {
